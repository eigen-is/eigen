...
- The Yjs way: `packages/lib/src/core/collab/hooks/use-collab-doc.ts`, `packages/lib/src/core/collab/hooks/use-yjs-undo-hotkeys.ts`, `packages/lib/src/core/collab/yjs-utils.ts`, `packages/ui/src/components/vector/hooks/use-canvas-doc.ts`, `apps/slides/src/components/slides/hooks/use-deck.ts`, `apps/stickies/src/components/stickies/hooks/use-board.ts`, `apps/api/src/lib/collab/collabDocument.ts` (`SNAPSHOT_INTERVAL`, `SNAPSHOT_BYTES`).
