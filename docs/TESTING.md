...
| `docker/test-release.sh` | The release gate the publish workflow runs before it builds: releases in a registry of its own, update, rollback, a breaking release, and the refused versions. |
