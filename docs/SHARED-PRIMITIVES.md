...
1359 primitives across 6 kinds. `packages/sheet` internals are excluded.
...
| `isReservedUsername` | `@workspace/lib/validation` | packages/lib/src/validation/username.ts |
