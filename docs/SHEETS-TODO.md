...
- Don't change the `sheet-copy-action-table` marker string — load-bearing in three modules and a committed test fixture, and any clipboard content copied before the change stops being recognised.
