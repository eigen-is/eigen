...
| **Instance lock**     | `apps/api/src/instance-lock.ts`              | One API process per data dir: `index.ts` takes it before anything opens a database. See [DATABASE.md § Instance lock](DATABASE.md#instance-lock) |
