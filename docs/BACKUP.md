...
- **A pre-blob archive restores its databases only**: the `cards/` and `calendars/` trees such an archive carries are not adopted, and a restored home serves what its databases hold.
