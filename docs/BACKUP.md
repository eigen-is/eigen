...
3. The home is evicted (every database closed, every timer canceled), its collab sockets are closed, and its part of the collab data epoch is rotated.
