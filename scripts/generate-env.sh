...
if [ -f .env.production ]; then
    eval "$(grep -E '^(ACME_EMAIL|MAIL_DOMAIN|COMPOSE_PROFILES|EIGEN_STATIC_BIND|SMTP_RELAY_HOST|SMTP_RELAY_PORT|SMTP_RELAY_USER|SMTP_RELAY_PASSWORD)=' .env.production)"
fi
