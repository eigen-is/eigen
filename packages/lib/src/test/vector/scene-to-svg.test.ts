...
// The golden scene: each shape type, both roundness variants, a two-line text, and the three linear
// renders — a freedraw stroke, a sharp open line, a round closed-and-filled line. Pins roughjs +
// perfect-freehand determinism (fixed seeds → byte-identical output run-to-run and across the pinned
// versions). After a deliberate renderer change, regenerate GOLDEN_SVG by pasting the output of
