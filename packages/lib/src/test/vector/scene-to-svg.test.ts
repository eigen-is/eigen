...
// renders (a freedraw stroke, a sharp open line, a round closed-and-filled line), and two arrows — a
// plain one with an end head, and a bound one with a triangle head and a clipped two-line label. Pins
