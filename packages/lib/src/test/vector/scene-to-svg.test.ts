...
// renders (a freedraw stroke, a sharp open line, a round closed-and-filled line), and four arrows — a
// plain one with an end head, a bound one with a triangle head and a clipped two-line label, a bound sharp
// elbow arrow whose orthogonal route is derived at render time (its `<g transform="translate(40 60)">`), and a
// bound round elbow on the same route whose bends render as quadratic corner arcs. Pins
