// The DOM a hook test renders into: one happy-dom window borrowed onto globalThis, put back again in
// afterAll so later test files in the same bun process see the environment they started with.
//
