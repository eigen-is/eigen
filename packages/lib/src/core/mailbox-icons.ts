...
import { AlertOctagon, Archive, File, Folder, Inbox, type LucideIcon, Send, Trash2 } from 'lucide-react';
...
// A mailbox the user made themselves has no special-use flag, so it reads as the plain folder it is.
export const CUSTOM_MAILBOX_ICON: LucideIcon = Folder;
