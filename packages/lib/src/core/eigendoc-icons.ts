...
import { FileText, type LucideIcon, MessageSquare, Presentation, Sheet, SquareKanban } from 'lucide-react';
...
// drive-new-menu, eigendoc-configs, and the command palette's create catalog all read it.
