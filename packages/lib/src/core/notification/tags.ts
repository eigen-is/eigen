...
// A chat notification's tag is the row's identity — persist() upserts on it, and the reader matches it
...
const COMMENT_NOTIFICATION_TYPES: readonly NotificationType[] = ['comment-reply', 'mention-comment'];
