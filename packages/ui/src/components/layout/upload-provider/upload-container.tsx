...
import {UploadItem} from "./upload-provider"
...
export function UploadContainer({
    ...
    return (
        <div
            className="fixed bottom-4 right-4 z-50 flex flex-col gap-2 max-w-md w-full transition-all duration-300 ease-in-out">
            {uploads.map((upload) => (
                <Card
                    key={upload.id}
                    className={cn(
