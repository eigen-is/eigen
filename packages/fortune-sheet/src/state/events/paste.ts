import {cloneDeep, forEach, fromPairs, has, includes, initial, isEmpty, isNil, isPlainObject, trim, zip} from "es-toolkit/compat";
                ...
                if (!isNil(index)) {
                    ...
                    forEach(trList, (tr) => {
                        ...
                        forEach(tr.querySelectorAll("td"), (td) => {
                            ...
                            cell.un = !includes(styles["text-decoration"], "underline")
                                ? undefined
                                : 1;
