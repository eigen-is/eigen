...
const Toolbar: React.FC<{
...
}> = ({ setMoreItems, moreItemsOpen, leftItems, rightItems }) => {
  ...
  return (
    <header>
      ...
      >
        {leftItems}
        {leftItems ? <Divider key="leftDivider" /> : null}
        ...
        {rightItems ? <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: "4px" }}>{rightItems}</div> : null}
      </div>
    </header>
  );
};
