...
const TextRotationNone: LucideIcon = React.forwardRef<SVGSVGElement, LucideProps>(({ className, ...props }, ref) => (
...
const TextRotationAngleUp: LucideIcon = React.forwardRef<SVGSVGElement, LucideProps>(({ className, ...props }, ref) => (
    <svg ref={ref} className={className} viewBox="0 0 24 24" fill="currentColor" stroke="none" {...props}>
        <path
...
const TextRotationAngleDown: LucideIcon = React.forwardRef<SVGSVGElement, LucideProps>(
    ({ className, ...props }, ref) => (
        <svg ref={ref} className={className} viewBox="0 0 24 24" fill="currentColor" stroke="none" {...props}>
            <path
...
const TextRotationVertical: LucideIcon = React.forwardRef<SVGSVGElement, LucideProps>(
    ({ className, ...props }, ref) => (
        <svg ref={ref} className={className} viewBox="0 0 24 24" fill="currentColor" stroke="none" {...props}>
            <path
...
const TextRotationUp: LucideIcon = React.forwardRef<SVGSVGElement, LucideProps>(({ className, ...props }, ref) => (
    <svg ref={ref} className={className} viewBox="0 0 24 24" fill="currentColor" stroke="none" {...props}>
        <path
...
const TextRotationDown: LucideIcon = React.forwardRef<SVGSVGElement, LucideProps>(({ className, ...props }, ref) => (
    <svg ref={ref} className={className} viewBox="0 0 24 24" fill="currentColor" stroke="none" {...props}>
        <path
...
const FilterFilled: LucideIcon = React.forwardRef<SVGSVGElement, LucideProps>(({ className, ...props }, ref) => (
    <svg ref={ref} className={className} viewBox="0 0 24 24" fill="currentColor" stroke="none" {...props}>
...
const FilterFilledWhite: LucideIcon = React.forwardRef<SVGSVGElement, LucideProps>(({ className, ...props }, ref) => (
...
const BorderStyle: LucideIcon = React.forwardRef<SVGSVGElement, LucideProps>(({ className, ...props }, ref) => (
    <svg
        ref={ref}
        className={className}
        viewBox="0 0 24 24"
