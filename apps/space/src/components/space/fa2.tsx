...
import { InfoIcon, ClipboardCopy, Check } from "lucide-react"
        ...
        <Form {...verificationForm}>
          <form onSubmit={verificationForm.handleSubmit(onVerificationSubmit)} className="space-y-6">
                ...
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  ...
                  <FormControl>
                    <div className="relative inline-flex h-[24px] w-[44px] shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-primary data-[state=unchecked]:bg-input"
                      ...
                      <span className="pointer-events-none block h-5 w-5 rounded-full bg-background shadow-lg ring-0 transition-transform duration-200 ease-in-out data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0"
                            data-state={field.value ? "checked" : "unchecked"} />
                    </div>
                  </FormControl>
                </FormItem>
            ...
            <div className="flex items-start gap-2 text-sm text-muted-foreground">
              ...
              <p>
                After enabling two-factor authentication, you'll need both your password and a verification code to sign in. 
                Make sure to save your recovery codes in a safe place in case you lose access to your authentication app.
              </p>
            </div>
