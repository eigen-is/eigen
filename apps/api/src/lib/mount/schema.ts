...
// Write-behind upload queue for S3-backed mounts. One row per storage key
...
// the plain files a restore stages (lib/backup/materialize.ts), which have no header to check.
