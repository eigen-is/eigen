...
// every vCard and message preview, every HTML/PDF/XLSX/DOCX export, the xlsx and docx imports
...
// A .vcf and an .eml hold no collaborative document: they preview from their own bytes, which
...
export type BytesPreviewJob = VCardPreviewJob | EmlPreviewJob;
...
// bytes-sourced jobs (the vCard and message previews, both imports) carry their own input instead.
