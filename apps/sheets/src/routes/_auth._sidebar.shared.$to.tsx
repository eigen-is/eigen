...
import {DRIVE_TYPE_SHEETS, DrivePath, DriveSearchParams, isDocumentType} from "@workspace/lib/types/drive";
...
function DriveRoute() {
    ...
    const folderContents = unfilteredFolderContents?.filter(path => path.type === DRIVE_TYPE_SHEETS) || [];
