...
description: "You can now try Eigen in your browser, without an install or an account. The demo is a shared workspace for a small festival, and it resets every hour."
---

I am still working on Eigen, a self-hosted alternative to Google Workspace. Until now, if you wanted to try it, you had to ask me for an account or install it yourself.
...
The demo is not empty. You land in a shared workspace of a fictional group of volunteers who are organizing the Tuimel Festival. Tuimel Festival is loosely based on the (very nice) Dutch [Festival Hongerige Wolf](https://www.festivalhongerigewolf.nl/).
