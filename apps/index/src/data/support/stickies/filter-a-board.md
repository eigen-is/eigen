...
2. Point at **Assigned to**.
3. Choose **Anyone**, **Me**, or **Unassigned**, or pick a person from the list underneath.

The list holds everyone the board is shared with. See
...
A card counts as open until someone resolves it.

1. Open the **Filter** menu and point at **Status**.
2. Choose **Open**, **Resolved**, or **All**.

A board starts on **All**, so resolved cards sit on the board alongside the rest until you change this.
...
Your filter is not saved. Close the board and open it again, and every card is back.

<div class="eigen-callout">

The find bar (**Ctrl+F**, or **Cmd+F** on a Mac) only searches the cards the filter is showing. If a card you
expected is missing from the results, clear the filter and search again.
