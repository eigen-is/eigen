...
description: "Use Eigen Mail, Calendar, and Drive from any IMAP, CalDAV, or WebDAV client by generating an app password on the Integrations page."
type: overview
tags: [connect, imap, caldav, webdav, app-passwords, integrations]
related: [connect/app-passwords, connect/mount-drive-on-your-computer]
order: 10
updated: 2026-06-08
---

Eigen works in the browser, but your Mail, Calendar, and Drive are also available to any standard client app on
your computer or phone. This page explains what you can connect and how credentials work.

## What you can connect

Open the [**Integrations** page](/space/services) in Space to see the connection details for all three protocols.
...
Your Eigen **email address** is the username for all three protocols: IMAP, CalDAV, and WebDAV.
