...
The file saves to your computer's default downloads folder.

You can also download a file from the detail panel. Click the file to open the panel on the right,
then click the **Download** button (the download icon next to the **Share** button).

## Download from a preview
...
Stickies, Chats, and folders do not have a download option.
