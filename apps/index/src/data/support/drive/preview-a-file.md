...
description: "Open a file in the full-screen preview, or use Quick preview to glance at a file without leaving the list."
type: how-to
category: Files
...
1. Right-click the file (or click its **⋮** button) to open the menu.
2. Choose **Quick preview**.
