...
2. Click the **More actions** menu (the **⋮** button) in the toolbar above the message.
3. Choose **Download**.

The message is saved to your computer as an `.eml` file.

## Download a message from the list

You don't have to open a message first.
