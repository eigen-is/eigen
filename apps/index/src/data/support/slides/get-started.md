---
title: "Get started with Slides"
description: "Create presentations in the browser, add text and images to a 16:9 canvas, and present your work in full screen."
type: overview
category: Basics
...
Open Slides from the app switcher. Your presentations are stored in Drive, so the main view shows your existing files. Click **New slide** to create a new presentation and open it straight away.

You can also create a presentation from Drive, or from any other Eigen app that shows the **New** button.
...
Click the **Present** button in the toolbar to enter full-screen presentation mode. Click anywhere to advance to the next slide. Right-click to go back. Slides exits presentation mode automatically after the last slide, or press **Escape** at any time to return to the editor.

## Share and export

Open the **File** menu in the toolbar to rename your presentation, share it with other people, or download it. Slides can export to PDF or as a web page (**File → Download → PDF (.pdf)** or **Web Page (.html)**).

To share, use **File → Share** or the **Share** button in the top-right corner of the toolbar. See [Share a presentation and comment](/support/slides/share-and-comment) for the full sharing options.
